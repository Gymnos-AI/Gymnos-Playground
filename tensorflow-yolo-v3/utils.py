...
def letter_box_image_old(image: Image.Image, output_height: int, output_width: int, fill_value)-> np.ndarray:
    """
    Fit image with final image with output_width and output_height.
    :param image: PILLOW Image object.
    :param output_height: width of the final image.
    ...
    fit_image = cv2.resize(image, dsize=(fit_width, fit_height), interpolation=cv2.INTER_CUBIC)
